...
if __name__ == "__main__":  
    ...
    guiWindow.geometry("650x550+850+450")  
    # disabling the resizable option  
    guiWindow.resizable(0, 0)  
    # setting the background color to #FAEBD7  
    guiWindow.configure(bg = "#EAEAEA")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#1E1E1E")  
    functions_frame = tk.Frame(guiWindow, bg = "#1E1E1E")  
    listbox_frame = tk.Frame(guiWindow, bg = "#1E1E1E")  
    ...
    header_label.pack(padx = 24, pady = 20)  
  
    # defining another label using the ttk.Label() widget  
    task_label = ttk.Label(  
        functions_frame,  
        text = "Enter the Task:",  
        font = ("HP Simplified", "20", "bold"),  
        background = "#C6E2FF",  
        foreground = "black"  
    )  
    ...
    del_button.place(x = 30, y = 220)  
    del_all_button.place(x = 30, y = 280)  
    exit_button.place(x =200, y = 340)  
